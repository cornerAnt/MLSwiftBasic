...
class Demo11ViewController: MBBaseViewController,UICollectionViewDataSource,UICollectionViewDelegate,MLPhotoBrowserViewControllerDelegate {
    ...
    func openPhotoBrowser(imageBtn:UIButton){
        ...
        // 展示
        photoBrowserVc.showPickerVc(self)
    }
