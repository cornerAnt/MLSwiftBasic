...
class Demo9ViewController: MBBaseViewController,UITableViewDataSource,UITableViewDelegate,MLPhotoPickerViewControllerDelegate {
    ...
    */
    override func rightClick() {
        ...
        pickerVc.status = .PhotoViewShowStatusVideo
