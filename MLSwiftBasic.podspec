#
#  Be sure to run `pod spec lint MLSwiftBasic.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "makezl"
  # s.authors            = { "makezl" => "ios.makezl@gmail.com" }
  # s.social_media_url   = "http://twitter.com/makezl"
